...
class _SearchScreenState extends State<SearchScreen>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) {
        context.read<SearchBloc>().add(FetchTrendingAnime());
      }
    });
  }
              ...
              decoration: InputDecoration(
                ...
                hintStyle: GoogleFonts.rubik(
                  color: Colors.white.withOpacity(
                    _placeholderAnimation.value * 0.40,
                  ),
                  fontSize: 16,
  ...
  Widget _buildContent() {
    return BlocBuilder<SearchBloc, SearchState>(
      builder: (context, state) {
        ...
        if (state is SearchTrendingLoading) {
          return _buildEmptyState(state.previousResults);
        }
      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            child: Text('Retry', style: GoogleFonts.rubik(fontSize: 14)),
          ),
        ],
      ),
    );
  ...
  Widget _buildEmptyState(List<HomeAnimeModel> trendingAnime) {
    ...
    // Show trending anime with title
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Padding(
  ...
  Widget _buildtrendingAnime(List<HomeAnimeModel> results) {
